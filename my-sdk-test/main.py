...
collpay_obj = collpay.Collpay("0810545410c0dd7822cdd7c7caa336b2", collpay.ENV_PRODUCTION, collpay.V1)
...
print(response['data']['transaction_id'])

response = collpay_obj.get_transaction("CP60700A06BB0CA")
print(response)
