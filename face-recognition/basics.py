...
imgSample = face_recognition.load_image_file('resources/samples/Bacchu.jpg')
imgSample = cv2.cvtColor(imgSample,cv2.COLOR_BGR2RGB)
imgTest = face_recognition.load_image_file('resources/tests/bacchu_test_2.jpg')
...
out = helpers.stackImages(0.5, [imgSample, imgTest])
